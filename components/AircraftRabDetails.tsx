  ...
  return (
    <section className="mt-8 w-full rounded-md border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-lg font-semibold text-slate-900">Dados atuais no RAB (ANAC)</h2>
        <a
      ...
      {snapshot.consulta_realizada_em && (
        <p className="mt-2 text-xs text-slate-500">Consulta ANAC: {snapshot.consulta_realizada_em}</p>
      )}
